...
var ProgressInfoUI=(function(_super){
		function ProgressInfoUI(){
			
		    this.progressBar=null;

			ProgressInfoUI.__super.call(this);
		}

		CLASS$(ProgressInfoUI,'ui.ProgressInfoUI',_super);
		var __proto__=ProgressInfoUI.prototype;
		__proto__.createChildren=function(){
		    
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(ProgressInfoUI.uiView);

		}

		ProgressInfoUI.uiView={"type":"View","props":{"width":480,"visible":true,"height":852},"child":[{"type":"ProgressBar","props":{"y":422,"x":90,"width":300,"visible":true,"var":"progressBar","value":0,"skin":"template/Progress/Loading_bar_icloud.png","sizeGrid":"0,6,0,6","height":8}}]};
		return ProgressInfoUI;
	})(View);