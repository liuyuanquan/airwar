...
// 资源
var assets = [{
    url: 'res/atlas/war.atlas',
    type: Laya.Loader.ATLAS
}, {
    url: 'res/sound/achievement.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/bullet.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/enemy1_down.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/enemy2_down.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/enemy3_down.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/enemy3_out.mp3',
    type: Laya.Loader.SOUND
}, {
    url: 'res/sound/game_over.mp3',
    type: Laya.Loader.SOUND
}]
this.progress = new ProgressInfo()
Laya.stage.addChild(this.progress)
// 加载进度条
Laya.loader.load('res/atlas/template/Progress.atlas', Laya.Handler.create(this, function() {
    // 加载图集资源
    Laya.loader.load(assets, Laya.Handler.create(self, onLoaded), Laya.Handler.create(self, onLoading, null, false))
}))
function onLoaded () {
    // 创建循环滚动的背景
